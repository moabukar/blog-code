...
| [ec2-to-fargate-java-migration](./ec2-to-fargate-java-migration/) | [EC2 to Fargate Java Migration](https://moabukar.co.uk/blog/ec2-to-fargate-java-migration) | Containerise Java apps and deploy to ECS Fargate |
| [elk-6-to-8-migration](./elk-6-to-8-migration/) | [ELK Stack Migration 6.x to 8.x](https://moabukar.co.uk/blog/elk-6-to-8-migration) | Complete guide to migrating Elasticsearch/Kibana |
...
| [terraform-migration](./terraform-migration/) | [Terraform 0.11 to 1.11 Migration](https://moabukar.co.uk/blog/terraform-011-to-111-migration) | Full migration guide with S3 bucket split scripts |
| [terraform-state-surgery](./terraform-state-surgery/) | [Terraform State Surgery](https://moabukar.co.uk/blog/terraform-state-surgery) | Splitting, moving, and refactoring Terraform state |
| [vertical-scaling-aurora](./vertical-scaling-aurora/) | [Vertical Autoscaling for Aurora](https://moabukar.co.uk/blog/vertical-scaling-aurora) | Lambda-based vertical autoscaling for Aurora |

## How to Use

Each directory has its own README with:
- Setup instructions
- File structure
- Quick start guide
- References
